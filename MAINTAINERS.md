...
- Christian Franzen (@cfranzen): the Java Testcontainers module.
- Hector Ventura (@hectorvent): release infrastructure and the emulator contracts the module targets.
