 ...
 * }</pre>
 */
public class EventBridgeConfig extends AbstractServiceConfig<EventBridgeConfig.Builder> {
     ...
     */
    public static class Builder extends AbstractServiceConfigBuilder<Builder, EventBridgeConfig> {
        ...
        /**
         * Creates a new builder initialized with the values of the given {@link EventBridgeConfig}.
         *
         * @param instance the configuration instance to copy values from
         */
        private Builder(EventBridgeConfig instance) {
            super(instance);
        }
